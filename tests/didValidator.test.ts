  ...
  describe('resolver method', () => {
    it('should fail for a valid web DID without LinkedVerifiablePresentation', async () => {
      ...
      expect(result.metadata).toEqual(
        expect.objectContaining({ status: TrustStatus.ERROR, errorCode: TrustErrorCode.NOT_FOUND }), // TODO: review this based on behaivor of services without valid credentials
      )
